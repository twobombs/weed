...
enum OCLAPI {
  ...
  OCL_API_SUB_REAL = 24,
  OCL_API_SUB_COMPLEX = 25,
  OCL_API_SUB_MIXED_C_LEFT = 26,
  OCL_API_SUB_MIXED_C_RIGHT = 27,
  OCL_API_DIV_REAL = 28,
  OCL_API_DIV_COMPLEX = 29,
  OCL_API_DIV_MIXED_C_LEFT = 30,
  OCL_API_DIV_MIXED_C_RIGHT = 31,
  OCL_API_ADD_IN_PLACE_REAL = 32,
  OCL_API_ADD_IN_PLACE_COMPLEX = 33,
  OCL_API_ADD_IN_PLACE_MIXED = 34,
  OCL_API_SUB_IN_PLACE_REAL = 35,
  OCL_API_SUB_IN_PLACE_COMPLEX = 36,
  OCL_API_SUB_IN_PLACE_MIXED = 37,
  OCL_API_FILL_VALUE_REAL = 38,
  OCL_API_FILL_VALUE_COMPLEX = 39
};
